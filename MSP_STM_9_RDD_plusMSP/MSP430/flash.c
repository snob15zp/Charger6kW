...
#define CSHIGH	NOP; /// rdd old hadware P5OUT |= FLASH_nCS; NOP; NOP
#define CSLOW	NOP; /// rdd old hadwareP5OUT &= ~( FLASH_nCS ); NOP; NOP
...
//	for ( ii = 0; ii < len; ii++ ) pDst[ii] = SPI_writeRead(0);
