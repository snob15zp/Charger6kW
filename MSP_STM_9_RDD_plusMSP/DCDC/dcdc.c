...
{
//	GPIOB->BSRR = GPIO_BSRR_BR_1;	//testDC?
		EXTI->PR=EXTI_IMR_MR0;
//	GPIOB->BSRR = GPIO_BSRR_BS_1;  //testDC?
...
//	delta_duty = (PERIOD_STEP * 100) / (buckPeriod / (dutyCycle / 100));  //spectr
	delta_duty = (buckPeriod *1000 / dutyCycle);  //spectr koef-t
	delta_duty = PERIOD_STEP*1000 / delta_duty  ;  //spectr delta_duty 
